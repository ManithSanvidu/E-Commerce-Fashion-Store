    ...
    return(
        <div className="glass rounded-[2rem] overflow-hidden transition-all duration-500 hover:scale-[1.05] hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] group">
            <div className="relative overflow-hidden h-80">
                <img src={product.image.startsWith('http') ? product.image : `http://localhost:5000${product.image}`} className="h-full w-full object-cover transition duration-700 group-hover:scale-110"/>
                {product.oldPrice && (
